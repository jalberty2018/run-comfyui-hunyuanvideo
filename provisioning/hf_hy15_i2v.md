# Manual provisioning Hunyuanvideo 1.5 i2v
...
```bash
hf download  Comfy-Org/HunyuanVideo_1.5_repackaged split_files/diffusion_models/hunyuanvideo1.5_720p_i2v_fp16.safetensors \
...
```bash
hf download  Comfy-Org/HunyuanVideo_1.5_repackaged split_files/diffusion_models/hunyuanvideo1.5_720p_i2v_cfg_distilled_fp16.safetensors \
--local-dir /workspace/ComfyUI/models/diffusion_models/
```
...
```bash
hf download Comfy-Org/HunyuanVideo_1.5_repackaged split_files/clip_vision/sigclip_vision_patch14_384.safetensors \
